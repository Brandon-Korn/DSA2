...
class MyRigidBody
{
	...
	vector3 localXAxis = AXIS_X; // this object's local X axis
	vector3 localYAxis = AXIS_Y; // this object's local Y axis
	vector3 localZAxis = AXIS_Z; // this object's local Z axis
...
#pragma region Accessors
	...
	*/
	...
	/*
	Usage: Gets this object's local X axis
	Arguments: ----
	Output: x axis vector 3
	*/
	vector3 GetLocalX(void);
	/*
	Usage: Gets this object's local Y axis
	Arguments: ----
	Output: y axis vector 3
	*/
	vector3 GetLocalY(void);
	/*
	Usage: Gets this object's local Z axis
	Arguments: ----
	Output: z axis vector 3
	*/
	vector3 GetLocalZ(void);
#pragma endregion
