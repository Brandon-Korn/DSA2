...
void MyCamera::CalculateView(void)
{
	...
	quaternion forwardQuaternion = glm::angleAxis(m_v3PitchYawRoll.x, m_v3Rightward);
	quaternion upwardQuaternion = glm::angleAxis(m_v3PitchYawRoll.y, m_v3Upward);
	quaternion rotationQuaternion = forwardQuaternion * upwardQuaternion;
	...
	m_v3Forward = glm::normalize(glm::rotate(rotationQuaternion, m_v3Forward));
	m_v3Target = m_v3Position + m_v3Forward;

	m_v3Rightward = glm::normalize(glm::rotate(rotationQuaternion, m_v3Rightward));
